...
D4DJChartRenderer.prototype.drawLine = function (
  ...
  var ex = this.getLaneWidth() * (end.LaneId + 0.5) + D4DJChartRenderer.X_OFFSET
  var sy =
...
D4DJChartRenderer.prototype.drawFlickArrow = function (note) {
  var x = this.getLaneWidth() * (note.LaneId + 0.5) + D4DJChartRenderer.X_OFFSET
  var y =
...
D4DJChartRenderer.prototype.renderChart = function (chart) {
  ...
  this.heightPerSec =
    this.targetCanvas.height / (chart.BarLineList[1] - chart.BarLineList[0]) / 4
